...
object ChapterProvider {
    //用于图片字的替换
    const val srcReplaceChar = "袮" //▩▣ //这是不应该存在的汉字,会替换为祢，这个字符用来标记
    const val srcReplaceCharC = '袮'
    ...
    // 以下注释函数见io/legado/app/ui/book/read/page/provider/TextChapterLayout.kt实现
    /**
     * 获取拆分完的章节数据
     */
